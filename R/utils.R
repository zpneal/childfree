.onAttach <- function(lib,pkg) {
  ...
  packageStartupMessage(" O    \U2506     CITE: Neal, Z. P. and Neal, J. W., (2024). Childfree: An R package for accessing")
  packageStartupMessage("  K   \U2587\U2500\U252C\U2500O and harmonizing childfree demographic data. CRAN.")
